...
-- --------------------------------------------------
-- Date Created: 05/24/2019 21:33:58
-- Generated from EDMX file: C:\Users\Alex\Desktop\ProjetoDA\Desenvolvimento-de-Aplica-es\ProjetoDA\Model1.edmx
-- --------------------------------------------------
...
CREATE TABLE [dbo].[Vendas] (
    ...
    [ClienteIdCliente2] int  NOT NULL,
...
-- Creating foreign key on [ClienteIdCliente2] in table 'Vendas'
ALTER TABLE [dbo].[Vendas]
ADD CONSTRAINT [FK_ClienteVenda]
    FOREIGN KEY ([ClienteIdCliente2])
...
-- Creating foreign key on [ClienteIdCliente1] in table 'Alugueres'
ALTER TABLE [dbo].[Alugueres]
...
-- Creating foreign key on [ClienteIdCliente1] in table 'Carros_CarroOficina'
ALTER TABLE [dbo].[Carros_CarroOficina]
